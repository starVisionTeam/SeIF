...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_ours.add_argument('--trainingDataRatio', type=float, default="0.998")  # gai cheng 0.998 de traindataset;
        ...
        g_train.add_argument('--continue_train', type=int, default=1, help='continue training: load the latest model')
        ...
        g_model.add_argument('--mlp_dim', nargs='+', default=[257, 1024, 512, 256, 128, 4], type=int,
