...
'''
change data_root and trainingDataRatio is ok!  2023/02/09 
'''
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_ours = parser.add_argument_group('SeIF')
        g_ours.add_argument('--meshDirSearch', type=str, default="/media/amax/4C76448F76447C28/FullData/facescape_fill")
        g_ours.add_argument('--trainingDataRatio', type=float, default="0.998")  #  0.998 traindataset;
        g_ours.add_argument('--datasetDir', type=str, default="/media/amax/4C76448F76447C28/FullData/Render")  # this is home of meshdata
        ...
        g_train.add_argument('--batch_size', type=int, default=3, help='input batch size')
        ...
        g_train.add_argument('--freq_plot', type=int, default=2000, help='freqency of the error plot')
        ...
        g_train.add_argument('--continue_train', type=int, default=0, help='continue training: load the latest model')

        # Testing related
        g_test = parser.add_argument_group('Testing')
        g_test.add_argument('--resolution', type=int, default=300, help='# of grid in mesh reconstruction')
        ...
        g_model.add_argument('--mlp_dim', nargs='+', default=[260, 1024, 512, 256, 128, 4], type=int,
